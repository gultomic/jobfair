<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}"  x-data="checkin()" x-init="checkin()">
    <head>
        <meta charset="utf-8">
        ...
        <div class="relative min-h-screen bg-gray-100 bg-center sm:flex sm:justify-center sm:items-center bg-dots-darker selection:bg-red-500 selection:text-white">
            ...
            <div class="p-6 mx-auto max-w-7xl lg:p-8">
                ...
                <div class="text-center">
                    ...
                    <p>{{ $attend->event->tanggal }}</p>
                    <p>{{ $attend->event->refs['lokasi'] }}</p>
                </div>
                ...
                <div class="mt-4 md:mt-10">
                    @if ($status)
                        ...
                        <div class="mt-4">
                            ...
                            <p class="-mt-2 text-xl font-bold">{{ $attend->user->name }}</p>
                            <label class="text-xs text-gray-500">Waktu check in:</label>
                            <p class="-mt-2 text-xl font-bold">{{ $attend->created_at }}</p>
                        </div>
                    @else
                        <div class="flex items-center justify-center text-red-500 gap-x-1">
                            ...
                            <span class="text-2xl font-black">Event berakhir</span>
                        </div>
                    @endif
                </div>
